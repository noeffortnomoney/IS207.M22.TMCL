					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 916754758</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> truongquocbinh2@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
                                <li><a href="https://www.facebook.com/hop.van.1258/"><i class="fa fa-facebook"></i></a></li>
				...
				<div class="row">
					<div class="col-md-2 clearfix">
						<div class="logo pull-left">
							<a href="<?=base?>"><img src="public/images/logo/logo_shopquanao.jpg" alt="" /></a>
						</div>
					</div>
    		...
    		<div class="row" style="margin-top: 100px;">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>TRUONGQUOCBINH</p>
							<p>KTX Khu A, ĐHQG TPHCM, TP.Thủ Đức, TPHCM</p>
							<p>Số Điện thoại: +84 916754758</p>
							<p>Email: truongquocbinh2@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
