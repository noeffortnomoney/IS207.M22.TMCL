                ...
                <tbody>
                    <?php foreach($data["listaccount"] as $key=>$values){ ?>
                        <tr class="even pointer">
                            ...
                            <td>
                                <a href="<?=base?>admin/statusaccountuser&id=<?=$values["id"]?>&status=<?=$values["active_status"]?>" style="height: 35px;min-width: 105px;" class="btn btn-primary" href=""><?=$values["active_status"]?></a> 
                            </td>
                        </tr>
                    <?php }?>
                </tbody>
